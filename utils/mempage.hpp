...
namespace util {
    ...
    struct MemPage {
        ...
        MemPage() = default;
        MemPage(std::string direct_string);
    ...
    public:
        ...
        void append_all(MemoryPages const& another);
        void erase_from_begin(const_iterator end);
        void erase_leading_pages(msize_t pages, msize_t offset_at_new_beginning);
        void erase_first_bytes(msize_t count);
